...
//Board passes information as a parameter in the takeTurn method  
	...
	//Print before shot      	  	
        ...
        System.out.println("Please enter 2 integers from 1 to 10 for rows and columns");    
    ...
    //Cannot exceed the grid boundary    	
    	if (row < 1 || row >10 || column <1 || column > 10) {
            System.out.println("[" + name + "] The numbers should between 1 to 10"); 
    ...
    //Hit a ship      	
    		...
    		if (guess.isShip.getHealth() == 0) {
    			...
    			//Print Results     			
    			System.out.println("[" + name + "] You have destroy a ship! And now your score is[" +score +"]");    			
    			System.out.println("The number of remaining ships is "+targetBoard.shipNum);    			
    		}
    		
	//Hit a ship, but the ship did not sink  		
    		else {
    			System.out.println("[" + name + "] Hitting the ship!");  }		
    		}
    	}
